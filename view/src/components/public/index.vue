  ...
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header has-drawer is-upgraded">
    <header role="banner" class="mdl-layout__header is-casting-shadow">
      ...
      <div class="mdl-layout__header-row">
        ...
        <nav class="mdl-navigation mdl-layout--large-screen-only">
          <a v-for="item of titleList" class="mdl-navigation__link" href="">{{item.name}}</a>
        </nav>
      </div>
    </header>
    <div class="mdl-layout__drawer">
      ...
      <nav class="mdl-navigation">
        <a class="mdl-navigation__link" href="">Link111</a>
        <a class="mdl-navigation__link" href="">Link222</a>
        <a class="mdl-navigation__link" href="">Link333</a>
        <a class="mdl-navigation__link" href="">Link444</a>
      </nav>
    </div>
...
export default {
  ...
  async created () {
    this.titleList = await window.ajax('get', '/api/title')
  },
  methods: {
    closeDrawer () {

...
// 七牛上传
var upload = function (containerId, bottonId, callBack, name) {
...
var addScripts = function () {
  var createSctipt = function (url) {
    console.log(url)
    let script = document.createElement('script')
    script.setAttribute('type', 'text/javascript')
    script.setAttribute('src', url)
    script.async = true
    common.q('head').appendChild(script)
  }
  createSctipt('http://7xu5y0.com1.z0.glb.clouddn.com/qiniu.min.js')
  createSctipt('http://7xu5y0.com1.z0.glb.clouddn.com/plupload.min.js')
  createSctipt('http://7xu5y0.com1.z0.glb.clouddn.com/moxie.min.js')
}

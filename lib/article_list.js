...
exports.getTitleById = (id) => Article_list.find({'id': id}).exec()

exports.getTitleList = () => Article_list.find().exec()

exports.getTitleByIdAndUpdate = (id, subTitlt) => Article_list
        .update({'id': id}, {$set: {subTitle: subTitlt}})
